namespace WebApp.AppFramework
{
    ...
    public static class Criteria
    {
        ...
        public static readonly AboutPageCriteria AboutPage = new AboutPageCriteria();

        public static readonly BDDSpecFlowPageCriteria BDDSpecFlowPage = new BDDSpecFlowPageCriteria();
